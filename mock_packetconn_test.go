...
//
//	mockgen -typed -package quic -self_package github.com/ruinstoriel/quic-go -self_package github.com/ruinstoriel/quic-go -destination mock_packetconn_test.go net PacketConn
//
