...
//
//	mockgen -build_flags=-tags=gomock -package mocks -destination stream_flow_controller.go github.com/apernet/quic-go/internal/flowcontrol StreamFlowController
//
