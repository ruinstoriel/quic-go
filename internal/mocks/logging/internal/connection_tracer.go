...
//
//	mockgen -build_flags=-tags=gomock -package internal -destination internal/connection_tracer.go github.com/apernet/quic-go/internal/mocks/logging ConnectionTracer
//
