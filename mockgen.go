...
//go:generate sh -c "go run go.uber.org/mock/mockgen -typed -build_flags=\"-tags=gomock\" -package quic -self_package github.com/ruinstoriel/quic-go -destination mock_stream_frame_getter_test.go github.com/ruinstoriel/quic-go StreamFrameGetter"
