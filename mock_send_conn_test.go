...
// Source: github.com/ruinstoriel/quic-go (interfaces: SendConn)
//
// Generated by this command:
//
//	mockgen -typed -build_flags=-tags=gomock -package quic -self_package github.com/ruinstoriel/quic-go -destination mock_send_conn_test.go github.com/ruinstoriel/quic-go SendConn
//
...
func (mr *MockSendConnMockRecorder) SetRemoteAddr(addr any) *MockSendConnSetRemoteAddrCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetRemoteAddr", reflect.TypeOf((*MockSendConn)(nil).SetRemoteAddr), addr)
